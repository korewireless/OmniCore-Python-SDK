...
import OmniCore
from OmniCore.models.new_registry import NewRegistry  # noqa: E501
from OmniCore.rest import ApiException

class TestNewRegistry(unittest.TestCase):
    """NewRegistry unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `NewRegistry`
        """
        model = OmniCore.models.new_registry.NewRegistry()  # noqa: E501
        if include_optional :
            return NewRegistry(
                id = '012', 
                credentials = [
