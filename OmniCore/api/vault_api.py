...
class VaultApi(object):
    ...
    @validate_arguments
    def enable_vault(self, subscriptionid : Annotated[StrictStr, Field(..., description="Subscription ID")], enable_vault : Annotated[Optional[EnableVault], Field(description="application/json")] = None, **kwargs) -> Details:  # noqa: E501
        """enable_vault  # noqa: E501

        Enable/Disable vault for a subscription  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.enable_vault(subscriptionid, enable_vault, async_req=True)
        >>> result = thread.get()

        :param subscriptionid: Subscription ID (required)
        :type subscriptionid: str
        :param enable_vault: application/json
        :type enable_vault: EnableVault
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.enable_vault_with_http_info(subscriptionid, enable_vault, **kwargs)  # noqa: E501

    @validate_arguments
    def enable_vault_with_http_info(self, subscriptionid : Annotated[StrictStr, Field(..., description="Subscription ID")], enable_vault : Annotated[Optional[EnableVault], Field(description="application/json")] = None, **kwargs):  # noqa: E501
        """enable_vault  # noqa: E501
        ...
        >>> thread = api.enable_vault_with_http_info(subscriptionid, enable_vault, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Details, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        # process the body parameter
        _body_params = None
        if _params['enable_vault']:
            _body_params = _params['enable_vault']
