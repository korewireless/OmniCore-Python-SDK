...
class DeviceApi(object):
    ...
    def get_devices_last_seen(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], page_number : Annotated[Optional[StrictInt], Field(description="Page Number")] = None, page_size : Annotated[Optional[StrictInt], Field(description="The maximum number of devices to return in the response. If this value is zero, the service will select a default size. ")] = None, field_mask : Annotated[Optional[StrictStr], Field(description="The fields of the Device resource to be returned to the response. The fields id and numId are always returned, along with any other fields specified. A comma-separated list of fully qualified names of fields. Example: ")] = None, sort_by_client_online : Annotated[Optional[StrictBool], Field(description="Set to true to return devices sorted by last heartbeat ")] = None, device_ids : Annotated[Optional[List[StrictStr]], Field(description="A list of device string IDs. For example, ['device0', 'device12']. If empty, this field is ignored. Maximum IDs: 10,000")] = None, device_num_ids : Annotated[Optional[List[StrictStr]], Field(description="A list of device numeric IDs. If empty, this field is ignored. Maximum IDs: 10,000.")] = None, gateway_list_options_associations_device_id : Annotated[Optional[StrictStr], Field(description="If set, returns only the gateways with which the specified device is associated. The device ID can be numeric (num_id) or the user-defined string (id). For example, if 456 is specified, returns only the gateways to which the device with num_id 456 is bound.")] = None, gateway_list_options_associations_gateway_id : Annotated[Optional[StrictStr], Field(description="If set, only devices associated with the specified gateway are returned. The gateway ID can be numeric (num_id) or the user-defined string (id). For example, if 123 is specified, only devices bound to the gateway with num_id 123 are returned")] = None, gateway_list_options_gateway_type : Annotated[Optional[StrictStr], Field(description="If GATEWAY is specified, only gateways are returned. If NON_GATEWAY is specified, only non-gateway devices are returned. If GATEWAY_TYPE_UNSPECIFIED is specified, all devices are returned.")] = None, **kwargs) -> ListDevicesOnlineResponse:  # noqa: E501
        ...
        :param field_mask: The fields of the Device resource to be returned to the response. The fields id and numId are always returned, along with any other fields specified. A comma-separated list of fully qualified names of fields. Example: 
        :type field_mask: str
        :param sort_by_client_online: Set to true to return devices sorted by last heartbeat 
        :type sort_by_client_online: bool
        :param device_ids: A list of device string IDs. For example, ['device0', 'device12']. If empty, this field is ignored. Maximum IDs: 10,000
        :type device_ids: List[str]
        :param device_num_ids: A list of device numeric IDs. If empty, this field is ignored. Maximum IDs: 10,000.
        :type device_num_ids: List[str]
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_devices_last_seen_with_http_info(subscription_id, page_number, page_size, field_mask, sort_by_client_online, device_ids, device_num_ids, gateway_list_options_associations_device_id, gateway_list_options_associations_gateway_id, gateway_list_options_gateway_type, **kwargs)  # noqa: E501

    @validate_arguments
    def get_devices_last_seen_with_http_info(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], page_number : Annotated[Optional[StrictInt], Field(description="Page Number")] = None, page_size : Annotated[Optional[StrictInt], Field(description="The maximum number of devices to return in the response. If this value is zero, the service will select a default size. ")] = None, field_mask : Annotated[Optional[StrictStr], Field(description="The fields of the Device resource to be returned to the response. The fields id and numId are always returned, along with any other fields specified. A comma-separated list of fully qualified names of fields. Example: ")] = None, sort_by_client_online : Annotated[Optional[StrictBool], Field(description="Set to true to return devices sorted by last heartbeat ")] = None, device_ids : Annotated[Optional[List[StrictStr]], Field(description="A list of device string IDs. For example, ['device0', 'device12']. If empty, this field is ignored. Maximum IDs: 10,000")] = None, device_num_ids : Annotated[Optional[List[StrictStr]], Field(description="A list of device numeric IDs. If empty, this field is ignored. Maximum IDs: 10,000.")] = None, gateway_list_options_associations_device_id : Annotated[Optional[StrictStr], Field(description="If set, returns only the gateways with which the specified device is associated. The device ID can be numeric (num_id) or the user-defined string (id). For example, if 456 is specified, returns only the gateways to which the device with num_id 456 is bound.")] = None, gateway_list_options_associations_gateway_id : Annotated[Optional[StrictStr], Field(description="If set, only devices associated with the specified gateway are returned. The gateway ID can be numeric (num_id) or the user-defined string (id). For example, if 123 is specified, only devices bound to the gateway with num_id 123 are returned")] = None, gateway_list_options_gateway_type : Annotated[Optional[StrictStr], Field(description="If GATEWAY is specified, only gateways are returned. If NON_GATEWAY is specified, only non-gateway devices are returned. If GATEWAY_TYPE_UNSPECIFIED is specified, all devices are returned.")] = None, **kwargs):  # noqa: E501
        """get_devices_last_seen  # noqa: E501
        ...
        >>> thread = api.get_devices_last_seen_with_http_info(subscription_id, page_number, page_size, field_mask, sort_by_client_online, device_ids, device_num_ids, gateway_list_options_associations_device_id, gateway_list_options_associations_gateway_id, gateway_list_options_gateway_type, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_devices_last_seen" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('field_mask') is not None:  # noqa: E501
            _query_params.append(('fieldMask', _params['field_mask']))
        if _params.get('sort_by_client_online') is not None:  # noqa: E501
            _query_params.append(('sortByClientOnline', _params['sort_by_client_online']))
        if _params.get('device_ids') is not None:  # noqa: E501
            _query_params.append(('deviceIds', _params['device_ids']))
            _collection_formats['deviceIds'] = 'csv'
        if _params.get('device_num_ids') is not None:  # noqa: E501
