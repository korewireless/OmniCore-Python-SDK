...
class DeviceApi(object):
    ...
    @validate_arguments
    def create_device(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], registry_id : Annotated[StrictStr, Field(..., description="Registry ID")], device : Annotated[NewDevice, Field(..., description="application/json")], **kwargs) -> Device:  # noqa: E501
    ...
    @validate_arguments
    def create_device_with_http_info(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], registry_id : Annotated[StrictStr, Field(..., description="Registry ID")], device : Annotated[NewDevice, Field(..., description="application/json")], **kwargs):  # noqa: E501
        """create_device  # noqa: E501
    ...
    @validate_arguments
    def send_configuration_to_device(self, subscriptionid : Annotated[StrictStr, Field(..., description="Subscription ID")], registry_id : Annotated[StrictStr, Field(..., description="Registry ID")], device_id : Annotated[StrictStr, Field(..., description="Device ID")], device : Annotated[DeviceConfiguration, Field(..., description="application/json")], **kwargs) -> DeviceConfig:  # noqa: E501
        """send_configuration_to_device  # noqa: E501

        Send A Config To A Device  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.send_configuration_to_device(subscriptionid, registry_id, device_id, device, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.send_configuration_to_device_with_http_info(subscriptionid, registry_id, device_id, device, **kwargs)  # noqa: E501

    @validate_arguments
    def send_configuration_to_device_with_http_info(self, subscriptionid : Annotated[StrictStr, Field(..., description="Subscription ID")], registry_id : Annotated[StrictStr, Field(..., description="Registry ID")], device_id : Annotated[StrictStr, Field(..., description="Device ID")], device : Annotated[DeviceConfiguration, Field(..., description="application/json")], **kwargs):  # noqa: E501
        """send_configuration_to_device  # noqa: E501
        ...
        >>> thread = api.send_configuration_to_device_with_http_info(subscriptionid, registry_id, device_id, device, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method send_configuration_to_device" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def update_device(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], registry_id : Annotated[StrictStr, Field(..., description="Registry ID")], device_id : Annotated[StrictStr, Field(..., description="Device ID")], update_mask : Annotated[StrictStr, Field(..., description="Required. Only updates the device fields indicated by this mask. The field mask must not be empty, and it must not contain fields that are immutable or only set by the server. Mutable top-level fields: credentials,log_level, blocked, and metadata")], device : Annotated[UpdateDevice, Field(..., description="application/json")], **kwargs) -> Device:  # noqa: E501
        ...
        :param device_id: Device ID (required)
        :type device_id: str
        :param update_mask: Required. Only updates the device fields indicated by this mask. The field mask must not be empty, and it must not contain fields that are immutable or only set by the server. Mutable top-level fields: credentials,log_level, blocked, and metadata (required)
