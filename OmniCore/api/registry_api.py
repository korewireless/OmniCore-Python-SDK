...
class RegistryApi(object):
    ...
    @validate_arguments
    def create_registry(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], registry : Annotated[NewRegistry, Field(..., description="application/json")], **kwargs) -> DeviceRegistry:  # noqa: E501
    ...
    @validate_arguments
    def create_registry_with_http_info(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], registry : Annotated[NewRegistry, Field(..., description="application/json")], **kwargs):  # noqa: E501
        """create_registry  # noqa: E501
    ...
    @validate_arguments
    def get_registries(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], page_number : Annotated[Optional[StrictInt], Field(description="Page Number")] = None, page_size : Annotated[Optional[StrictInt], Field(description="Page Size")] = None, **kwargs) -> ListDeviceRegistriesResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListDeviceRegistriesResponse
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_registries_with_http_info(self, subscription_id : Annotated[StrictStr, Field(..., description="Subscription ID")], page_number : Annotated[Optional[StrictInt], Field(description="Page Number")] = None, page_size : Annotated[Optional[StrictInt], Field(description="Page Size")] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListDeviceRegistriesResponse, status_code(int), headers(HTTPHeaderDict))
        """
