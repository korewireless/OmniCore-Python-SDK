...
class VaultStatusDetails(BaseModel):
    ...
    retention_period: Optional[StrictInt] = Field(None, alias="retentionPeriod")
    ...
    __properties = ["subscriptionId", "storageType", "isEnabled", "isCreated", "updatedon", "createdOn", "MqttId", "retentionPeriod", "encryptionKeyId", "isEncrypted"]
    ...
    def from_dict(cls, obj: dict) -> VaultStatusDetails:
        ...
        _obj = VaultStatusDetails.parse_obj({
            ...
            "retention_period": obj.get("retentionPeriod"),
