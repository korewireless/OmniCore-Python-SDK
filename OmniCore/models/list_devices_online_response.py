...
class ListDevicesOnlineResponse(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    devices: List[DeviceOnline] = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDevicesOnlineResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDevicesOnlineResponse:
        """Create an instance of ListDevicesOnlineResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListDevicesOnlineResponse.parse_obj(obj)

        _obj = ListDevicesOnlineResponse.parse_obj({
            "devices": [DeviceOnline.from_dict(_item) for _item in obj.get("devices")] if obj.get("devices") is not None else None,
