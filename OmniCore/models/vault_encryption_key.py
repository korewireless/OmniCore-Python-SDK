...
class VaultEncryptionKey(BaseModel):
    ...
    __properties = ["subscription", "name", "id", "key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VaultEncryptionKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VaultEncryptionKey:
        """Create an instance of VaultEncryptionKey from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VaultEncryptionKey.parse_obj(obj)

        _obj = VaultEncryptionKey.parse_obj({
