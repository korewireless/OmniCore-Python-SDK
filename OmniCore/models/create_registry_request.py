...
class CreateRegistryRequest(BaseModel):
    ...
    __properties = ["id", "credentials", "httpConfig", "mqttConfig", "logLevel", "eventNotificationConfigs", "logNotificationConfig", "stateNotificationConfig"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRegistryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRegistryRequest:
        """Create an instance of CreateRegistryRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateRegistryRequest.parse_obj(obj)

        _obj = CreateRegistryRequest.parse_obj({
            "id": obj.get("id"),
