...
class StartExportBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartExportBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartExportBody:
        """Create an instance of StartExportBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return StartExportBody.parse_obj(obj)

        _obj = StartExportBody.parse_obj({
