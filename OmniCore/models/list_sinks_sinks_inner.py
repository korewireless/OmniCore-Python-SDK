...
class ListSinksSinksInner(BaseModel):
    ...
    config: Optional[ListSinksSinksInnerConfig] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSinksSinksInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSinksSinksInner:
        """Create an instance of ListSinksSinksInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListSinksSinksInner.parse_obj(obj)

        _obj = ListSinksSinksInner.parse_obj({
            "id": obj.get("id"),
            "subscription": obj.get("subscription"),
            "sink": obj.get("sink"),
            "config": ListSinksSinksInnerConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None,
