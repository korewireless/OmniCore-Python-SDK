...
class Replay(BaseModel):
    ...
    __properties = ["id", "registry", "startTime", "endTime", "subscription", "destination", "source", "status", "size", "count"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Replay:
        """Create an instance of Replay from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Replay.parse_obj(obj)

        _obj = Replay.parse_obj({
            "id": obj.get("id"),
