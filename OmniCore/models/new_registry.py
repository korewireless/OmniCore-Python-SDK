...
class NewRegistry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewRegistry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewRegistry:
        """Create an instance of NewRegistry from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NewRegistry.parse_obj(obj)

        _obj = NewRegistry.parse_obj({
            "id": obj.get("id"),
