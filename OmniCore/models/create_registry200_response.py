...
class CreateRegistry200Response(BaseModel):
    ...
    __properties = ["id", "name", "parent", "createdOn", "updatedOn", "credentials", "httpConfig", "mqttConfig", "logLevel", "eventNotificationConfigs", "logNotificationConfig", "stateNotificationConfig", "numberOfDevices", "numberOfGateways"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRegistry200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRegistry200Response:
        """Create an instance of CreateRegistry200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateRegistry200Response.parse_obj(obj)

        _obj = CreateRegistry200Response.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
