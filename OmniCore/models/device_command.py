...
class DeviceCommand(BaseModel):
    ...
    """
    binary_data: StrictStr = Field(..., alias="binaryData", description="Base64 Encoded Command String")
    subfolder: Optional[StrictStr] = None
    __properties = ["binaryData", "subfolder"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceCommand:
        """Create an instance of DeviceCommand from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeviceCommand.parse_obj(obj)

        _obj = DeviceCommand.parse_obj({
