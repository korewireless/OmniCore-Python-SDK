...
class UpdateRegistry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRegistry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRegistry:
        """Create an instance of UpdateRegistry from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UpdateRegistry.parse_obj(obj)

        _obj = UpdateRegistry.parse_obj({
