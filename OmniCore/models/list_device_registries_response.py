...
class ListDeviceRegistriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDeviceRegistriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDeviceRegistriesResponse:
        """Create an instance of ListDeviceRegistriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListDeviceRegistriesResponse.parse_obj(obj)

        _obj = ListDeviceRegistriesResponse.parse_obj({
