...
class Device(BaseModel):
    ...
    __properties = ["id", "name", "numId", "parent", "registry", "blocked", "capresent", "subscription", "createdOn", "updatedOn", "credentials", "gateway", "gatewayConfig", "isGateway", "deviceErrors", "clientOnline", "lastConfigAckTime", "lastConfigSendTime", "lastErrorStatus", "lastErrorTime", "lastEventTime", "lastHeartbeatTime", "lastStateTime", "logLevel", "metadata", "config", "state", "policy"]
