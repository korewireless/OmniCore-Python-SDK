...
class Metrics(BaseModel):
    ...
    """
    details: Optional[MetricsDetails] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Metrics:
        """Create an instance of Metrics from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Metrics.parse_obj(obj)

        _obj = Metrics.parse_obj({
            "details": MetricsDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
        return _obj
