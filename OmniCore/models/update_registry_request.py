...
class UpdateRegistryRequest(BaseModel):
    ...
    __properties = ["credentials", "httpConfig", "mqttConfig", "logLevel", "eventNotificationConfigs", "logNotificationConfig", "stateNotificationConfig"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRegistryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRegistryRequest:
        """Create an instance of UpdateRegistryRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UpdateRegistryRequest.parse_obj(obj)

        _obj = UpdateRegistryRequest.parse_obj({
